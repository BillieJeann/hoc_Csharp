...
namespace Chương_6
{
    ...
    //            if (students[i] != null)
    //            {
    //                int count = CountAddr(students, students[i]);

    //                if (CheckAddr(addrs, i, students[i].Address))
    //                {
    //                    addrs[index] = new ListAddr(students[i].Address, count);
    ...
    //            {
    //                if (addrs[i] != null && addrs[j] != null && addrs[i].Count < addrs[j].Count)
    //                {
    //                    Swap(ref addrs[i], ref addrs[j]);
    //                }
    //            }
    //        }
    ...
    //    private static int CountAddr(Student[] students, Student student)
    //    {
    //        int count = 0;
    //        foreach (var item in students)
    //        {
    //            if (item != null && student != null && item.Address == student.Address)
    //            {
    //                count++;
    //            }
    //        }
    ...
    //    private static bool CheckAddr(ListAddr[] addrs, int current, string ward)
    //    {
    //        for (int i = 0; i < current; i++)
    //        {
    //            if (addrs[i].Addr == ward)
    //            {
    //                return false;
    //            }
    //        }
    ...
    //    private static void Swap(ref ListAddr student1, ref ListAddr student2)
    //    {
    //        ListAddr tmp = student1;
    //        student1 = student2;
    //        student2 = tmp;
    //    }
